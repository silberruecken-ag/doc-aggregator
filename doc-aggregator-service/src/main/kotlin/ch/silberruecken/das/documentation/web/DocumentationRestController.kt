...
class DocumentationRestController(private val documentationService: DocumentationService) {
    @PutMapping
    fun createOrUpdateDocumentation(@Valid @RequestBody documentation: CreateDocumentationDto): ResponseEntity<Documentation> {
        return documentationService.createOrUpdateDocumentation(documentation.toDomain())
